...
def ask_mistral[T](
    ...
    *,
    ...
    """Call Mistral API with structured output using native parse method. Returns BackendResult.
    ...
    up to JSON_PARSE_MAX_RETRIES times for such errors.
    ...
    for attempt in range(max_attempts):
        try:
            ...
            return BackendResult(
                ...
                structured_output_retries=json_parse_attempts,
            )
